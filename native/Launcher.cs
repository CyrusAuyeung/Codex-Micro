...
internal static class Launcher {
    ...
    internal static bool Running(){return ServiceVersion()=="1.1.6";}
    ...
    private static void WaitForPreviousLauncher(string version){
        string previousName=version=="1.0.0"?"Local\\MicroWindowsLauncher":version=="1.1.0"?"Local\\MicroWindowsLauncher11":version=="1.1.1"?"Local\\MicroWindowsLauncher111":version=="1.1.2"?"Local\\MicroWindowsLauncher112":version=="1.1.3"?"Local\\MicroWindowsLauncher113":version=="1.1.4"?"Local\\MicroWindowsLauncher114":"Local\\MicroWindowsLauncher115";
    ...
    [STAThread] private static int Main(string[] args) {
        ...
        try {
            ...
            if(previousVersion=="1.0.0"||previousVersion=="1.1.0"||previousVersion=="1.1.1"||previousVersion=="1.1.2"||previousVersion=="1.1.3"||previousVersion=="1.1.4"||previousVersion=="1.1.5"){Stop();WaitForPreviousLauncher(previousVersion);for(int i=0;i<25&&ServiceVersion()!=null;i++)Thread.Sleep(200);}
            bool first;using(var single=new Mutex(true,"Local\\MicroWindowsLauncher116",out first)) {
