...
try {
  ...
  for (const route of ['/', '/codex', '/views/ordinary', '/views/codex', '/profile-manager.js', '/hardware.css', '/hardware.js', '/mapping-core.js', '/app.js', '/style.css','/desktop.js','/desktop.css','/components.js','/record.js','/device-info.js','/next.css']) {
